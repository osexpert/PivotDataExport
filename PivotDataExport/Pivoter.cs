...
namespace PivotDataExport
{
	...
	public class Pivoter<TRow> where TRow : class // class notnull
	{
		...
		public Pivoter(IEnumerable<TRow> rows, IEnumerable<IField<TRow>> fields)
		{
		...
		private List<List<Group<TRow>>> GroupRows(IEnumerable<IField<TRow>> fields, RootType rootType)//, bool sort = false)
		{
